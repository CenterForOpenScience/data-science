...
percent_24 <- intersections %>%
  ...
  tally() %>%
  ungroup() %>%
  mutate(`2-4 Months` = round(100 *n/nrow(intersections_24), 2)) %>%
  select(`2-4 Months`)
...
percent_68 <- intersections %>%
  ...
  tally() %>%
  ungroup() %>%
  mutate(`6-8 Months` = round(100 *n/nrow(intersections_68), 2)) %>%
  select(`6-8 Months`)
...
percent_1012 <- intersections %>%
  ...
  tally() %>%
  ungroup() %>%
  mutate(`10-12 Months` = round(100 *n/nrow(intersections_1012), 2)) %>%
  select(`10-12 Months`)
...
percent_2224 <- intersections %>% 
  ...
  tally() %>%
  ungroup() %>%
  mutate(`22-24 Months` = round(100 *n/nrow(intersections_2224), 2)) %>%
  select(`22-24 Months`)

project_type <- c("Empty", "Empty & Public", "Registered", "Registered & Public", "File", "File & Public", "File & Registered", "File & Public & Registered")

totals <- c("N", nrow(intersections_24), nrow(intersections_68), nrow(intersections_1012), nrow(intersections_2224))
