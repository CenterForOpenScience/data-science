...
The graph below shows the number of non-deleted projects that have each action and the intersections of those actions. There are `r nrow(projects_by_product)` total non-deleted projects. 
