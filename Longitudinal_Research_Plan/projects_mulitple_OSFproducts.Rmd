...
The graph shows the number of top-level projects that were created each month that either *only* share files, *only* have a registration, do both of these things, or do neither of these things.
