...
#### What does logtime look like by project type?
```{r warning=FALSE, echo=FALSE, message=FALSE}
...
\
\
#### What does logtime look like by project type and quartile?

**Caveats**

* I've excluded log types that show up less than 5% for all quartiles and all project types.
