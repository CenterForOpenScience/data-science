...
user_data <- read_csv('/Users/courtneysoderberg/Downloads/user_activity2.csv', col_types = cols(merged_by_id = col_character()))
```
...
arrange(product) %>%
mutate_if(~is.numeric(.), list(`prc` = ~round(100*./.[13],2))) %>%
