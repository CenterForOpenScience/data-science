...
user_categorization <- user_data %>%
                          ...
                          mutate(preprint_creator = case_when(num_preprints > 0 ~ 1,
                                 ...
                                 user_type = case_when(preprint_user == 0 & osf4m_user == 0 & osf_node_user == 0 & registrations_user == 0 & suppnode_user == 0 ~ 'No products',
                                                       ...
                                                       preprint_user == 0 & registrations_user == 0 & public_sharing_user == 1 ~ 'Only projects',
                                                       ...
                                                       preprint_user == 0 & registrations_user == 1 & public_sharing_user == 1 ~ 'Projects & Regs',
                                                       preprint_user == 1 & registrations_user == 0 & public_sharing_user == 1 ~ 'Projects & Preprints',
                        ...
                        mutate(user_type = fct_relevel(user_type, "No products", "Only private storage", "Only projects", "Only regs", "Only preprints", "Projects & Regs", "Projects & Preprints", "Regs & Preprints", "All three"))
