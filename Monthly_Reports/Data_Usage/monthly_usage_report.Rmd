...
by_node_storage <- read_csv('nondel_nodedata.csv', col_types = cols(deleted_on = col_skip(),
                 ...
                 group_by(target_guid, target_is_public) %>%
...
Storage calculated for all nodes individually, nesting of nodes within top-level projects is not taken into account
