...
* Number of public nodes at/above cap since cap implemented: `r num_public_above - monthly_cap_info[1, 2]`
* Overall percentage of public nodes: `r perc_public_nodes`%
* Percentage of public nodes at/above cap: `r perc_public_above`%
* Percentage of public nodes above private cap: `r perc_public_above_5GB`%

\

* Number of private nodes at/above cap since cap implemented: `r num_private_above - monthly_cap_info[1, 3]`
* Overall percentage of private nodes: `r perc_private_nodes`%
* Percentage of private nodes at/above cap: `r perc_private_above`%

\

* Percentage of Top-level projects with at least 1 node that exceed the storage cap: 
    + public: `r perc_toplevel_public_above`%
    + private: `r perc_toplevel_private_above`%
