...
form_data <- read_csv(paste0(here::here('Registrations/', 'form_type_monthly.csv'))) 
total_regs <- read_csv(paste0(here::here('Registrations/', 'monthly_total_regs.csv'))) %>%
...
### Change in Number of Embargoed Registrations  {.value-box}
